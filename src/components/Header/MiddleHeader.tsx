...
const MiddleHeader = () => {
  ...
  return (
    <>
      <div className="flex items-center justify-center gap-5 py-6 px-20 sticky z-20 top-0">
        <div>
          <p className="text:xs md:text-md lg:text-xl font-extrabold text-darkText flex items-center gap-2">
            <span className="-mt-2">
              <Image
                src={logo}
                alt="logo"
                className="w-10 h-10 hidden md:inline-flex"
              />
            </span>{" "}
            <span className="text-sm text-redText spFont">Savour Express</span>
          </p>
        </div>
